...
namespace StudioReservationAPP.Migrations
{
    ...
    [Migration("20220727134220_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudioReservationAPP.Core.Entities.Classes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudioReservationAPP.Core.Entities.MemberLesson", b =>
                {
                    ...
                    b.Property<int?>("MemberLessonLessonId")
                        .HasColumnType("int");

                    b.Property<int?>("MemberLessonMemberId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MemberLessonMemberId", "MemberLessonLessonId");
            ...
            modelBuilder.Entity("StudioReservationAPP.Core.Entities.Lesson", b =>
                {
                    ...
                    b.HasOne("StudioReservationAPP.Core.Entities.Classes", "Classes")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("StudioReservationAPP.Core.Entities.MemberLesson", b =>
                {
                    ...
                    b.HasOne("StudioReservationAPP.Core.Entities.MemberLesson", null)
                        .WithMany("WaitingQueue")
                        .HasForeignKey("MemberLessonMemberId", "MemberLessonLessonId");
